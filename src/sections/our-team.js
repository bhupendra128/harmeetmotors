...
import MotorImage1 from 'assets/images/motor/MotorImage1.jpeg';
import MotorImage2 from 'assets/images/motor/MotorImage2.jpeg';
import MotorImage3 from 'assets/images/motor/MotorImage3.jpeg';
  ...
  return (
    <Box as="section" id="team" sx={styles.section}>
      <Container ref={containerRef}>
        <SectionHeading
          sx={styles.heading}
          title="Buy Mini Trucks and Buses"
          description="Buy any type of Mini Trucks and Buses, for more detail, contact our sales team"
        />
      </Container>
      <Box
        sx={{
